...
class ShellClient():
    ...
    def print_options_login(self):        
        print('<--- Opciones --->')
        print('1. Ver Nuevos Tweets')
        print('2. Crear Tweet')
        #print('3. Crear ReTweet')
        print('4. Ver Perfil')
        #print('5. Mi Perfil')
            ...
            while True:
                ...
                if succesed:
                    ...
                    for t in tweet:
                        ...
                        temp.append(t)
                        i+=1
                    print('|======< FIN de los Tweets >======|')
                    
                    #print('|======< ReTweets del Perfil >======|')
                    # for r in retweet:
    ...
    def create_tweet(self):
        ...
        while True:
            ...
            print('<--- Crear Tweet --->')
            print('Paso 1: Ingrese el texto del Tweet. Recuerde que solo puede contener 255 caracteres')
            print('> ', end='')
            text = input()

            print('Paso 2: Confirmar subida. Especifique la opcion que desee realizar.')
            print('1. Publicar Tweet')
            print('2. Editar Tweet')
            print('3. Cancelar Tweet')
            option = input()
            if option == '1':
                while True:
                    succesed, error = self.client.tweet(text, self.token, self.nick)
                    if succesed:
                        print('Tweet PUBLICADO CON EXITO!!!')
                        print('Pulse ENTER para volver al menu principal')
                        input()
                        return
                    else:
