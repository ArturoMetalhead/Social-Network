...
def main():
    ...
    server_manager = Twitter_Server(twitter_servers,chord_node)
    server_manager2 = Twitter_Server(twitter_servers,chord_node)
    server_manager3 = Twitter_Server(twitter_servers,chord_node)
